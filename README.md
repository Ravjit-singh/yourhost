...
Open that http url in any browser and click start server , you can manage everything from here and also turn the server off after you are done playing
If you want to restart the server just type the following command:

start-mc

This will restart the server and then you can manage server via the same method via using that http url
